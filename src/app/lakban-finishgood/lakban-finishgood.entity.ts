...
import { ILakbanFinishgood } from './interface/lakban-finishgood.interface';

@Entity()
export class LakbanFinishgood implements ILakbanFinishgood{
  constructor(data: ILakbanFinishgood) {
    if (!!data) {
      this.id = data.id;
